...
import {fetchCategoriesS} from '../../store/categories/category.action'
const Shop=()=>{
    const dispatch = useDispatch();
        ...
        // const getCategoriesMap=async () => { 
          ...
          useEffect(()=>{
        dispatch(fetchCategoriesAsync());//A normal component that triggers when the moment this component mounts
 },[]);
        // };
